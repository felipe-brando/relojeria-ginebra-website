...
var reactIs = __webpack_require__(364);
...
var root = __webpack_require__(2373);
...
var Symbol = __webpack_require__(2596),
    getRawTag = __webpack_require__(8703),
    objectToString = __webpack_require__(888);
...
var Symbol = __webpack_require__(2596),
    arrayMap = __webpack_require__(8644),
    isArray = __webpack_require__(163),
    isSymbol = __webpack_require__(1995);
...
var trimmedEndIndex = __webpack_require__(4120);
...
var freeGlobal = __webpack_require__(2117);
...
var isObject = __webpack_require__(7709),
    now = __webpack_require__(6987),
    toNumber = __webpack_require__(5812);
...
var baseGetTag = __webpack_require__(563),
    isObjectLike = __webpack_require__(3474);
...
var baseTrim = __webpack_require__(1367),
    isObject = __webpack_require__(7709),
    isSymbol = __webpack_require__(1995);
...
var baseToString = __webpack_require__(6316);
...
var toString = __webpack_require__(7010);
...
/* harmony export */   "Z": function() { return /* binding */ photon; }
/* harmony export */ });
/* harmony import */ var crc32__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9626);
...
/* harmony import */ var debug__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6431);
...
const debug = debug__WEBPACK_IMPORTED_MODULE_2___default()( 'photon' );
...
function serverFromPathname( pathname ) {
	const hash = crc32__WEBPACK_IMPORTED_MODULE_0___default()( pathname );
	const rng = seed_random__WEBPACK_IMPORTED_MODULE_1___default()( hash );
...
var ReactPropTypesSecret = __webpack_require__(5843);
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "E": function() { return /* binding */ ReactReduxContext; }
/* harmony export */ });
...
"use strict";
/* harmony import */ var _babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4206);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3804);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1268);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _Context__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1992);
...
/* harmony default export */ __webpack_exports__["Z"] = (Provider);
...
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(6773);
/* harmony import */ var _babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(4206);
/* harmony import */ var _babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(1629);
/* harmony import */ var _babel_runtime_helpers_esm_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(7841);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3804);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var react_is__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(364);
/* harmony import */ var _Context__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1992);
...
_ref) {
  ...
  invariant__WEBPACK_IMPORTED_MODULE_1___default()(storeKey === 'store', 'storeKey has been removed and does not do anything. ' + customStoreWarningMessage);
  var Context = context;
  return function wrapWithConnect(WrappedComponent) {
    ...
    var OuterBaseComponent = react__WEBPACK_IMPORTED_MODULE_2__.Component;

    if (pure) {
      OuterBaseComponent = react__WEBPACK_IMPORTED_MODULE_2__.PureComponent;
    }
    ...
    function makeChildElementSelector() {
      ...
      return function selectChildElement(WrappedComponent, childProps, forwardRef) {
        if (childProps !== lastChildProps || forwardRef !== lastForwardRef || lastComponent !== WrappedComponent) {
          ...
          lastChildElement = react__WEBPACK_IMPORTED_MODULE_2___default().createElement(WrappedComponent, (0,_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_6__/* .default */ .Z)({}, childProps, {
            ref: forwardRef
          }));
        }
    ...
    function (_OuterBaseComponent) {
      ...
      _proto.renderWrappedComponent = function renderWrappedComponent(value) {
        invariant__WEBPACK_IMPORTED_MODULE_1___default()(value, "Could not find \"store\" in the context of " + ("\"" + displayName + "\". Either wrap the root component in a <Provider>, ") + "or pass a custom React context provider to <Provider> and the corresponding " + ("React context consumer to " + displayName + " in connect options."));
      ...
      _proto.render = function render() {
        var ContextToUse = this.props.context && this.props.context.Consumer && (0,react_is__WEBPACK_IMPORTED_MODULE_3__.isContextConsumer)(react__WEBPACK_IMPORTED_MODULE_2___default().createElement(this.props.context.Consumer, null)) ? this.props.context : Context;
        return react__WEBPACK_IMPORTED_MODULE_2___default().createElement(ContextToUse.Consumer, null, this.indirectRenderWrappedComponent);
      };
    ...
    if (forwardRef) {
      var forwarded = react__WEBPACK_IMPORTED_MODULE_2___default().forwardRef(function forwardConnectRef(props, ref) {
        return react__WEBPACK_IMPORTED_MODULE_2___default().createElement(Connect, {
          wrapperProps: props,
          forwardedRef: ref
        });
      });
...
/* harmony import */ var _babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(1629);
/* harmony import */ var _babel_runtime_helpers_esm_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(7841);
...
/* harmony import */ var _mapStateToProps__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6150);
/* harmony import */ var _mergeProps__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(4262);
/* harmony import */ var _selectorFactory__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(7189);
...
/* harmony default export */ __webpack_exports__["Z"] = (createConnect());
...
/* harmony import */ var redux__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4978);
/* harmony import */ var _wrapMapToProps__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8821);


function whenMapDispatchToPropsIsFunction(mapDispatchToProps) {
  return typeof mapDispatchToProps === 'function' ? (0,_wrapMapToProps__WEBPACK_IMPORTED_MODULE_0__/* .wrapMapToPropsFunc */ .xv)(mapDispatchToProps, 'mapDispatchToProps') : undefined;
}
function whenMapDispatchToPropsIsMissing(mapDispatchToProps) {
  return !mapDispatchToProps ? (0,_wrapMapToProps__WEBPACK_IMPORTED_MODULE_0__/* .wrapMapToPropsConstant */ .dX)(function (dispatch) {
    return {
      dispatch: dispatch
    };
  }) : undefined;
...
function whenMapDispatchToPropsIsObject(mapDispatchToProps) {
  return mapDispatchToProps && typeof mapDispatchToProps === 'object' ? (0,_wrapMapToProps__WEBPACK_IMPORTED_MODULE_0__/* .wrapMapToPropsConstant */ .dX)(function (dispatch) {
    return (0,redux__WEBPACK_IMPORTED_MODULE_1__/* .bindActionCreators */ .DE)(mapDispatchToProps, dispatch);
  }) : undefined;
}
/* harmony default export */ __webpack_exports__["ZP"] = ([whenMapDispatchToPropsIsFunction, whenMapDispatchToPropsIsMissing, whenMapDispatchToPropsIsObject]);
...
function whenMapStateToPropsIsFunction(mapStateToProps) {
  return typeof mapStateToProps === 'function' ? (0,_wrapMapToProps__WEBPACK_IMPORTED_MODULE_0__/* .wrapMapToPropsFunc */ .xv)(mapStateToProps, 'mapStateToProps') : undefined;
}
function whenMapStateToPropsIsMissing(mapStateToProps) {
  return !mapStateToProps ? (0,_wrapMapToProps__WEBPACK_IMPORTED_MODULE_0__/* .wrapMapToPropsConstant */ .dX)(function () {
    return {};
  }) : undefined;
}
/* harmony default export */ __webpack_exports__["ZP"] = ([whenMapStateToPropsIsFunction, whenMapStateToPropsIsMissing]);
...
/* harmony import */ var _babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1629);
...
/* harmony default export */ __webpack_exports__["ZP"] = ([whenMergePropsIsFunction, whenMergePropsIsOmitted]);
...
/* harmony import */ var _babel_runtime_helpers_esm_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7841);
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "dX": function() { return /* binding */ wrapMapToPropsConstant; },
/* harmony export */   "xv": function() { return /* binding */ wrapMapToPropsFunc; }
/* harmony export */ });
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "zt": function() { return /* reexport safe */ _components_Provider__WEBPACK_IMPORTED_MODULE_0__.Z; },
/* harmony export */   "$j": function() { return /* reexport safe */ _connect_connect__WEBPACK_IMPORTED_MODULE_3__.Z; }
/* harmony export */ });
/* harmony import */ var _components_Provider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2054);
/* harmony import */ var _components_connectAdvanced__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4193);
/* harmony import */ var _components_Context__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1992);
/* harmony import */ var _connect_connect__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8274);
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Z": function() { return /* binding */ shallowEqual; }
/* harmony export */ });
...
/* harmony export */ });
/* unused harmony exports __DO_NOT_USE__ActionTypes, compose */
/* harmony import */ var symbol_observable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3488);
...
var GLOBAL = typeof window === 'undefined' ? window : window;
...
"use strict";
/* harmony import */ var _ponyfill_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2752);
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Z": function() { return /* binding */ symbolObservablePonyfill; }
/* harmony export */ });
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Z": function() { return /* binding */ AppWrapper; }
/* harmony export */ });
...
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2620);
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1205);
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3163);
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _instant_search_components_search_app__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7758);
/* harmony import */ var _instant_search_store__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(5820);
/* harmony import */ var _instant_search_lib_api__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(7722);
/* harmony import */ var _instant_search_lib_constants__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(9379);
/* harmony import */ var _instant_search_lib_dom__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(7266);
/* harmony import */ var _hooks_use_loading_state__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(3877);
/* harmony import */ var _hooks_use_search_options__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(9396);
...
const alias__ = _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__;
const __ = alias__;
...
const PROPS_FROM_WINDOW = {
  aggregations: (0,_instant_search_lib_api__WEBPACK_IMPORTED_MODULE_6__/* .buildFilterAggregations */ .a5)([...window[_instant_search_lib_constants__WEBPACK_IMPORTED_MODULE_7__/* .SERVER_OBJECT_NAME */ .W1].widgets, ...window[_instant_search_lib_constants__WEBPACK_IMPORTED_MODULE_7__/* .SERVER_OBJECT_NAME */ .W1].widgetsOutsideOverlay]),
  defaultSort: window[_instant_search_lib_constants__WEBPACK_IMPORTED_MODULE_7__/* .SERVER_OBJECT_NAME */ .W1].defaultSort,
  hasOverlayWidgets: !!window[_instant_search_lib_constants__WEBPACK_IMPORTED_MODULE_7__/* .SERVER_OBJECT_NAME */ .W1].hasOverlayWidgets,
  options: window[_instant_search_lib_constants__WEBPACK_IMPORTED_MODULE_7__/* .SERVER_OBJECT_NAME */ .W1],
  themeOptions: (0,_instant_search_lib_dom__WEBPACK_IMPORTED_MODULE_10__/* .getThemeOptions */ .C)(window[_instant_search_lib_constants__WEBPACK_IMPORTED_MODULE_7__/* .SERVER_OBJECT_NAME */ .W1])
};
/**
...
function AppWrapper() {
  const {
    ...
    theme,
    trigger
  } = (0,_hooks_use_search_options__WEBPACK_IMPORTED_MODULE_9__/* .default */ .Z)();
  const overlayOptions = { ...window[_instant_search_lib_constants__WEBPACK_IMPORTED_MODULE_7__/* .SERVER_OBJECT_NAME */ .W1].overlayOptions,
    // Override with defined values from Gutenberg preview.
    ...(0,lodash__WEBPACK_IMPORTED_MODULE_2__.pickBy)({
      colorTheme: theme,
      defaultSort: sort,
  ...
  }) : /*#__PURE__*/React.createElement(react_redux__WEBPACK_IMPORTED_MODULE_1__/* .Provider */ .zt, {
    store: _instant_search_store__WEBPACK_IMPORTED_MODULE_5__/* .default */ .Z
  }, /*#__PURE__*/React.createElement(_instant_search_components_search_app__WEBPACK_IMPORTED_MODULE_4__/* .default */ .Z, _home_runner_work_jetpack_jetpack_node_modules_pnpm_babel_runtime_7_15_3_node_modules_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({}, PROPS_FROM_WINDOW, {
...
function Header({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "jp-search-configure-header"
  }, /*#__PURE__*/React.createElement("div", {
    className: "jp-search-configure-header__navigable-toolbar-wrapper"
  }, /*#__PURE__*/React.createElement("h1", {
    className: "jp-search-configure-header__title"
  }, title)), /*#__PURE__*/React.createElement("div", {
    className: "jp-search-configure-header__actions"
  ...
  }, /*#__PURE__*/React.createElement(_wordpress_icons__WEBPACK_IMPORTED_MODULE_3__/* .default */ .Z, {
    icon: _wordpress_icons__WEBPACK_IMPORTED_MODULE_4__/* .default */ .Z
  }))));
}
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3027);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5707);
/* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_data__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _wordpress_viewport__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8270);
...
/* harmony import */ var _interface__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8435);
/* harmony import */ var _lib_analytics__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3369);
/* harmony import */ var _lib_constants__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(3920);
/* harmony import */ var _instant_search_lib_constants__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9379);
/**
 * WordPress dependencies
 */
...
function Layout() {
  const {
    ...
    isLargeViewport: select(_wordpress_viewport__WEBPACK_IMPORTED_MODULE_2__.store).isViewportMatch('large')
  }));
  const [enabledSidebarName, setSidebarName] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(_lib_constants__WEBPACK_IMPORTED_MODULE_6__/* .OPTIONS_TAB_IDENTIFIER */ .E);

  const disableSidebar = () => setSidebarName(null);

  const enableSidebar = (name = _lib_constants__WEBPACK_IMPORTED_MODULE_6__/* .OPTIONS_TAB_IDENTIFIER */ .E) => setSidebarName(name);

  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    (0,_lib_analytics__WEBPACK_IMPORTED_MODULE_4__/* .initialize */ .j2)();
    (0,_lib_analytics__WEBPACK_IMPORTED_MODULE_4__/* .identifySite */ .AM)(window[_instant_search_lib_constants__WEBPACK_IMPORTED_MODULE_5__/* .SERVER_OBJECT_NAME */ .W1].siteId);
    (0,_lib_analytics__WEBPACK_IMPORTED_MODULE_4__/* .recordEvent */ .Ny)(`${_lib_analytics__WEBPACK_IMPORTED_MODULE_4__/* .eventPrefix */ .q0}_page_view`);
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "jp-search-configure-root"
  }, /*#__PURE__*/React.createElement(_interface__WEBPACK_IMPORTED_MODULE_3__/* .default */ .Z, {
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Z": function() { return /* binding */ Interface; }
/* harmony export */ });
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3163);
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _app_wrapper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5463);
/* harmony import */ var _header__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8266);
/* harmony import */ var _sidebar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2738);
/**
 * WordPress dependencies
 */
...
function Interface(props) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "interface-interface-skeleton"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    role: "region",
    tabIndex: "-1"
  }, /*#__PURE__*/React.createElement(_sidebar__WEBPACK_IMPORTED_MODULE_3__/* .default */ .Z, {
    disableSidebar: disableSidebar,
    enabledSidebarName: enabledSidebarName,
    enableSidebar: enableSidebar
  })))));
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Z": function() { return /* binding */ ColorControl; }
/* harmony export */ });
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6399);
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3163);
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5707);
...
function ColorControl({
  ...
  const colors = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.useSelect)(select => {
    ...
    const settings = (_select$getSettings = select('core/block-editor').getSettings()) !== null && _select$getSettings !== void 0 ? _select$getSettings : {};
    return Array.isArray(settings === null || settings === void 0 ? void 0 : settings.colors) && settings.colors.length > 0 ? settings.colors : DEFAULT_COLORS;
  });
  return /*#__PURE__*/React.createElement("div", {
    className: "jp-search-configure-color-input components-base-control"
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Z": function() { return /* binding */ ExcludedPostTypesControl; }
/* harmony export */ });
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3027);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7997);
...
function ExcludedPostTypesControl({
  disabled,
  onChange,
  validPostTypes = VALID_POST_TYPES,
  value
}) {
  const validPostTypeNames = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => Object.keys(validPostTypes), [validPostTypes]);
  const selectedValues = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "jp-search-configure-excluded-post-types-control components-base-control"
  }, /*#__PURE__*/React.createElement("div", {
    className: "jp-search-configure-excluded-post-types-control__label"
  }, __('Excluded post types', 'jetpack')), isLastUnchecked && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Notice, {
    isDismissible: false,
    status: "info"
  }, __('You must leave at least one post type unchecked.', 'jetpack')), validPostTypeNames.map(type => /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.CheckboxControl, {
...
function Sidebar(props) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "interface-complementary-area jp-search-configure-sidebar"
  }, /*#__PURE__*/React.createElement("div", {
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Z": function() { return /* binding */ SidebarDescription; }
/* harmony export */ });
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6399);
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7997);
...
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3163);
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _instant_search_components_jetpack_colophon__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5504);
/* harmony import */ var _wordpress_url__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(791);
...
function SidebarDescription() {
  return /*#__PURE__*/React.createElement("div", {
    className: "jp-search-configure-sidebar-description"
  }, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.BlockIcon, {
    icon: _instant_search_components_jetpack_colophon__WEBPACK_IMPORTED_MODULE_3__/* .svg */ .Y
  }), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", null, __('Jetpack Instant Search will allow your visitors to get search results as soon as they start typing. Customize this experience to offer better results that match your site.', 'jetpack')), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, {
    href: 'widgets.php',
    isTertiary: true
  }, __('Edit widgets', 'jetpack')), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, {
    href: (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_4__.addQueryArgs)('customize.php', {
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Z": function() { return /* binding */ SidebarOptions; }
/* harmony export */ });
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9105);
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(classnames__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7997);
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3163);
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _hooks_use_loading_state__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3877);
/* harmony import */ var _hooks_use_entity_record_state__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(232);
/* harmony import */ var _hooks_use_search_options__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9396);
/* harmony import */ var _color_control__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(4319);
/* harmony import */ var _excluded_post_types_control__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(3859);
/* harmony import */ var _theme_control__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(9825);
/**
 * External dependencies
 */
...
function SidebarOptions() {
  const {
    ...
    theme,
    trigger
  } = (0,_hooks_use_search_options__WEBPACK_IMPORTED_MODULE_5__/* .default */ .Z)();
  const {
    isSaving
  } = (0,_hooks_use_entity_record_state__WEBPACK_IMPORTED_MODULE_4__/* .default */ .Z)();
  const {
    isLoading
  } = (0,_hooks_use_loading_state__WEBPACK_IMPORTED_MODULE_3__/* .default */ .Z)();
  const isDisabled = isSaving || isLoading; // TODO: ask the user if they attempt to navigate away from the page with pending changes.

  return /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Panel, {
    className: classnames__WEBPACK_IMPORTED_MODULE_0___default()('jp-search-configure-sidebar-options', {
      'jp-search-configure-sidebar-options--is-disabled': isDisabled
    })
  }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelBody, {
    title: __('Styling', 'jetpack'),
    initialOpen: true
  }, /*#__PURE__*/React.createElement(_theme_control__WEBPACK_IMPORTED_MODULE_8__/* .default */ .Z, {
    disabled: isDisabled,
    onChange: setTheme,
    value: theme
    ...
    options: [{
      label: __('Minimal', 'jetpack'),
      value: 'minimal'
    }, {
      label: __('Expanded (shows images)', 'jetpack'),
      value: 'expanded'
    }, {
      label: __('Product (for WooCommerce stores)', 'jetpack'),
      value: 'product'
    }],
    onChange: setResultFormat
  }), /*#__PURE__*/React.createElement(_color_control__WEBPACK_IMPORTED_MODULE_6__/* .default */ .Z, {
    disabled: isDisabled,
    onChange: setColor,
    value: color
  })), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelBody, {
    title: __('Search options', 'jetpack'),
    initialOpen: true
    ...
    value: sort,
    options: [{
      label: __('Relevance (recommended)', 'jetpack'),
      value: 'relevance'
    }, {
      label: __('Newest first', 'jetpack'),
      value: 'newest'
    }, {
      label: __('Oldest first', 'jetpack'),
      value: 'oldest'
    }],
    onChange: setSort
  }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.SelectControl, {
    ...
    value: trigger,
    options: [{
      label: __('Open when the user starts typing', 'jetpack'),
      value: 'immediate'
    }, {
      label: __('Open when results are available', 'jetpack'),
      value: 'results'
    }, {
      label: __('Open when user submits the form', 'jetpack'),
      value: 'submit'
    }],
    onChange: setTrigger
  }), /*#__PURE__*/React.createElement(_excluded_post_types_control__WEBPACK_IMPORTED_MODULE_7__/* .default */ .Z, {
    disabled: isDisabled,
    onChange: setExcludedPostTypes,
    value: excludedPostTypes
  })), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelBody, {
    title: __('Additional settings', 'jetpack'),
    initialOpen: true
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Z": function() { return /* binding */ Tabs; }
/* harmony export */ });
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9105);
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(classnames__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3163);
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7997);
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _lib_constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3920);
/**
 * External dependencies
 */
...
function Tabs({
  ...
  return /*#__PURE__*/React.createElement("ul", null, /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement(Tab, {
    enableSidebar: enableSidebar,
    identifier: _lib_constants__WEBPACK_IMPORTED_MODULE_3__/* .JP_SEARCH_TAB_IDENTIFIER */ .m,
    isActive: enabledSidebarName === _lib_constants__WEBPACK_IMPORTED_MODULE_3__/* .JP_SEARCH_TAB_IDENTIFIER */ .m,
    label: __('Jetpack Search', 'jetpack')
  })), /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement(Tab, {
    enableSidebar: enableSidebar,
    identifier: _lib_constants__WEBPACK_IMPORTED_MODULE_3__/* .OPTIONS_TAB_IDENTIFIER */ .E,
    isActive: enabledSidebarName === _lib_constants__WEBPACK_IMPORTED_MODULE_3__/* .OPTIONS_TAB_IDENTIFIER */ .E,
...
function Tab({
  ...
  const ariaLabel = isActive ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.sprintf)(__('%s (selected)', 'jetpack'), label) : label;
  return /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button // eslint-disable-next-line react/jsx-no-bind
  , {
    onClick: () => enableSidebar(identifier),
    className: classnames__WEBPACK_IMPORTED_MODULE_0___default()('jp-search-configure-sidebar__panel-tab', {
      'is-active': isActive
    }),
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Z": function() { return /* binding */ ThemeControl; }
/* harmony export */ });
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9105);
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(classnames__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7997);
...
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3163);
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _theme_icon__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5922);
/**
 * External dependencies
 */
...
function ThemeControl({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "jp-search-configure-theme-buttons components-base-control"
    ...
    variant: "link"
  }, /*#__PURE__*/React.createElement(_theme_icon__WEBPACK_IMPORTED_MODULE_3__/* .default */ .Z, {
    theme: "light"
  }), /*#__PURE__*/React.createElement("span", {
    "aria-label": __('Light Theme', 'jetpack')
  }, __('Light', 'jetpack'))), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, {
    className: classnames__WEBPACK_IMPORTED_MODULE_0___default()({
    ...
    "aria-label": __('Dark Theme', 'jetpack')
  }, __('Dark', 'jetpack'))));
}
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Z": function() { return /* binding */ ThemeIcon; }
/* harmony export */ });
/**
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Z": function() { return /* binding */ useEntityRecordState; }
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3804);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5707);
...
function useEntityRecordState() {
  const {
    saveEntityRecord,
    undo,
    redo
  } = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.useDispatch)('core');
  const editedEntities = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.useSelect)(select => select('core').getEntityRecordEdits('root', 'site'));
  const hasUnsavedEdits = editedEntities && Object.keys(editedEntities).length > 0;
  const isSaving = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.useSelect)(select => select('core').isSavingEntityRecord('root', 'site'));
  const hasRedo = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.useSelect)(select => select('core').hasUndo());
  const hasUndo = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.useSelect)(select => select('core').hasRedo());
  const saveRecords = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(() => {
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Z": function() { return /* binding */ useSiteLoadingState; }
/* harmony export */ });
/* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5707);
...
function useSiteLoadingState() {
  const site = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.useSelect)(select => select('core').getSite());
  return {
    isLoading: !site
  };
}
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Z": function() { return /* binding */ useSearchOptions; }
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3804);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _wordpress_core_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6791);
...
function useSearchOptions() {
  const [theme, setTheme] = (0,_wordpress_core_data__WEBPACK_IMPORTED_MODULE_1__.useEntityProp)('root', 'site', 'jetpack_search_color_theme');
  const [resultFormat, setResultFormat] = (0,_wordpress_core_data__WEBPACK_IMPORTED_MODULE_1__.useEntityProp)('root', 'site', 'jetpack_search_result_format');
  const [sort, setSort] = (0,_wordpress_core_data__WEBPACK_IMPORTED_MODULE_1__.useEntityProp)('root', 'site', 'jetpack_search_default_sort');
  const [trigger, setTrigger] = (0,_wordpress_core_data__WEBPACK_IMPORTED_MODULE_1__.useEntityProp)('root', 'site', 'jetpack_search_overlay_trigger');
  const [color, setColor] = (0,_wordpress_core_data__WEBPACK_IMPORTED_MODULE_1__.useEntityProp)('root', 'site', 'jetpack_search_highlight_color');
  const [sortEnabled, setSortEnabled] = (0,_wordpress_core_data__WEBPACK_IMPORTED_MODULE_1__.useEntityProp)('root', 'site', 'jetpack_search_enable_sort');
  const [infiniteScroll, setInfiniteScroll] = (0,_wordpress_core_data__WEBPACK_IMPORTED_MODULE_1__.useEntityProp)('root', 'site', 'jetpack_search_inf_scroll');
  const [showLogo, setShowLogo] = (0,_wordpress_core_data__WEBPACK_IMPORTED_MODULE_1__.useEntityProp)('root', 'site', 'jetpack_search_show_powered_by');
  const [excludedPostTypesCsv, setExcludedPostTypesCsv] = (0,_wordpress_core_data__WEBPACK_IMPORTED_MODULE_1__.useEntityProp)('root', 'site', 'jetpack_search_excluded_post_types'); // Excluded Post Types is stored as a CSV string in site options. Convert into array of strings.
  // Caveat: csv can be an empty string, which can produces [ '' ] if only csv.split is used.

  const excludedPostTypes = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => excludedPostTypesCsv === null || excludedPostTypesCsv === void 0 ? void 0 : excludedPostTypesCsv.split(',').filter(type => (type === null || type === void 0 ? void 0 : type.length) > 0), [excludedPostTypesCsv]);
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "q0": function() { return /* binding */ eventPrefix; },
/* harmony export */   "j2": function() { return /* binding */ initialize; },
/* harmony export */   "AM": function() { return /* binding */ identifySite; },
/* harmony export */   "Ny": function() { return /* binding */ recordEvent; }
/* harmony export */ });
/* harmony import */ var _instant_search_lib_tracks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(814);
/**
 * Internal dependencies
 */
...
const eventPrefix = 'jetpack_search_customberg'; // Force enable analytics! Ignore isAnalyticsEnabled flag used by the Instant Search application.

const initialize = (...args) => (0,_instant_search_lib_tracks__WEBPACK_IMPORTED_MODULE_0__/* .initializeTracks */ .tU)(...args, true);
const identifySite = (...args) => (0,_instant_search_lib_tracks__WEBPACK_IMPORTED_MODULE_0__/* .identifySite */ .AM)(...args, true);
const recordEvent = (...args) => (0,_instant_search_lib_tracks__WEBPACK_IMPORTED_MODULE_0__/* .recordEvent */ .Ny)(...args, true);
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "m": function() { return /* binding */ JP_SEARCH_TAB_IDENTIFIER; },
/* harmony export */   "E": function() { return /* binding */ OPTIONS_TAB_IDENTIFIER; }
/* harmony export */ });
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3804);
...
class CustomizerEventHandler extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
  constructor(...args) {
    super(...args);
...
class DomEventHandler extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
  constructor() {
    super(...arguments);
...
class Gridicon extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
  ...
  getSVGTitle(icon) {
    ...
    if ('title' in this.props) {
      return this.props.title ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("title", null, this.props.title) : null;
    }
    ...
    switch (icon) {
      ...
      case 'gridicons-audio':
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("title", null, __('Has audio.', 'jetpack'));

      case 'gridicons-calendar':
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("title", null, __('Is an event.', 'jetpack'));

      case 'gridicons-cart':
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("title", null, __('Is a product.', 'jetpack'));

      case 'chevron-down':
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("title", null, __('Show filters', 'jetpack'));

      case 'gridicons-comment':
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("title", null, __('Matching comment.', 'jetpack'));

      case 'gridicons-cross':
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("title", null, __('Close search results', 'jetpack'));

      case 'gridicons-filter':
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("title", null, __('Toggle search filters.', 'jetpack'));

      case 'gridicons-folder':
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("title", null, __('Category', 'jetpack'));

      case 'gridicons-image-multiple':
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("title", null, __('Has multiple images.', 'jetpack'));

      case 'gridicons-image':
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("title", null, __('Has an image.', 'jetpack'));

      case 'gridicons-page':
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("title", null, __('Page', 'jetpack'));

      case 'gridicons-post':
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("title", null, __('Post', 'jetpack'));

      case 'gridicons-jetpack-search':
      case 'gridicons-search':
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("title", null, __('Search', 'jetpack'));

      case 'gridicons-tag':
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("title", null, __('Tag', 'jetpack'));

      case 'gridicons-video':
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("title", null, __('Has a video.', 'jetpack'));
    }
  }
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Y": function() { return /* binding */ svg; }
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3804);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3163);
...
const logoSize = 12;
const svg = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("svg", {
...
const JetpackColophon = props => {
  ...
  }, svg, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
...
const Notice = ({
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_gridicon__WEBPACK_IMPORTED_MODULE_1__/* .default */ .Z, {
    icon: "info",
    size: 20
  }), children);
};
...
const PathBreadcrumbs = ({
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    href: `//${url}`,
    onClick: onClick
  }, breadcrumbPieces.map((piece, index, pieces) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
...
const PhotonImage = props => {
  ...
  const [lazySrc, setLazySrc] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("img", _home_runner_work_jetpack_jetpack_node_modules_pnpm_babel_runtime_7_15_3_node_modules_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
    alt: alt,
    ref: image,
    src: lazySrc
  }, otherProps));
...
const PostTypeIcon = ({
  ...
  if (Object.keys(POST_TYPE_TO_ICON_MAP).includes(postType)) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_gridicon__WEBPACK_IMPORTED_MODULE_1__/* .default */ .Z, {
...
class ProductPrice extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
  render() {
    const {
      formattedPrice,
      formattedSalePrice,
    ...
    }, salePrice > 0 ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("s", {
...
function ProductRatings({
  ...
  }, Array(5).fill( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_gridicon__WEBPACK_IMPORTED_MODULE_2__/* .default */ .Z, {
    size: 16,
    icon: "star-outline"
  })).fill( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_gridicon__WEBPACK_IMPORTED_MODULE_2__/* .default */ .Z, {
    size: 16,
    icon: "star"
  }), 0, rating)), ' ', /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("a", {
    "aria-hidden": true,
  ...
  _n('%d review', '%d reviews', count, 'jetpack'), count)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("span", {
    className: "screen-reader-text"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.sprintf)(
...
class ScrollButton extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
  constructor(...args) {
    super(...args);
  ...
  render() {
    ...
    }, this.props.isLoading ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("span", null, __('Loading…', 'jetpack')) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("span", null, __('Load more', 'jetpack')));
  }
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3804);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var react_dom__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7196);
/* harmony import */ var react_dom__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react_dom__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var lodash_debounce__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5034);
/* harmony import */ var lodash_debounce__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(lodash_debounce__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(2620);
/* harmony import */ var fast_json_stable_stringify__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(8027);
...
/* harmony import */ var _customizer_event_handler__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(8260);
/* harmony import */ var _dom_event_handler__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(6250);
/* harmony import */ var _overlay__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(5968);
/* harmony import */ var _search_results__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(8898);
/* harmony import */ var _lib_tracks__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(814);
/* harmony import */ var _lib_constants__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(9379);
/* harmony import */ var _lib_filters__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(8033);
/* harmony import */ var _lib_query_string__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(227);
/* harmony import */ var _store_actions__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(7717);
/* harmony import */ var _store_selectors__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(1248);
...
class SearchApp extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
  constructor() {
    super(...arguments);
    ...
    _home_runner_work_jetpack_jetpack_node_modules_pnpm_babel_runtime_7_15_3_node_modules_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(this, "getResultFormat", () => {
      ...
      const resultFormatQuery = (0,_lib_query_string__WEBPACK_IMPORTED_MODULE_13__/* .getResultFormatQuery */ .ug)(); // Override the result format if group static filter is selected, always use expanded.
      ...
      if (isMultiSite) {
        return _lib_constants__WEBPACK_IMPORTED_MODULE_11__/* .RESULT_FORMAT_EXPANDED */ .Pz;
      }
    ...
    _home_runner_work_jetpack_jetpack_node_modules_pnpm_babel_runtime_7_15_3_node_modules_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(this, "initializeStaticFilters", () => {
      const availableStaticFilters = (0,_lib_filters__WEBPACK_IMPORTED_MODULE_12__/* .getAvailableStaticFilters */ .bA)();
    ...
    _home_runner_work_jetpack_jetpack_node_modules_pnpm_babel_runtime_7_15_3_node_modules_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(this, "hideResults", isHistoryNav => {
      ...
      (0,_lib_query_string__WEBPACK_IMPORTED_MODULE_13__/* .restorePreviousHref */ .Q0)(this.props.initialHref, () => {
        this.setState({
          isVisible: false
        });
    ...
    this.getResults = lodash_debounce__WEBPACK_IMPORTED_MODULE_3___default()(this.getResults, 200);
    this.props.enableAnalytics ? this.initializeAnalytics() : (0,_lib_tracks__WEBPACK_IMPORTED_MODULE_10__/* .disableAnalytics */ .IJ)();
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    fast_json_stable_stringify__WEBPACK_IMPORTED_MODULE_5___default()(prevProps.filters) !== fast_json_stable_stringify__WEBPACK_IMPORTED_MODULE_5___default()(this.props.filters) || fast_json_stable_stringify__WEBPACK_IMPORTED_MODULE_5___default()(prevProps.staticFilters) !== fast_json_stable_stringify__WEBPACK_IMPORTED_MODULE_5___default()(this.props.staticFilters)) {
    ...
    if (fast_json_stable_stringify__WEBPACK_IMPORTED_MODULE_5___default()(prevState.overlayOptions.excludedPostTypes) !== fast_json_stable_stringify__WEBPACK_IMPORTED_MODULE_5___default()(this.state.overlayOptions.excludedPostTypes)) {
      this.getResults();
    }
  }

  initializeAnalytics() {
    (0,_lib_tracks__WEBPACK_IMPORTED_MODULE_10__/* .initializeTracks */ .tU)();
    (0,_lib_tracks__WEBPACK_IMPORTED_MODULE_10__/* .resetTrackingCookies */ .vy)();
    (0,_lib_tracks__WEBPACK_IMPORTED_MODULE_10__/* .identifySite */ .AM)(this.props.options.siteId);
  }
  ...
  render() {
    ...
    const portalFn = this.props.shouldCreatePortal ? react_dom__WEBPACK_IMPORTED_MODULE_2__.createPortal : noop;
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, this.props.isInCustomizer && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_customizer_event_handler__WEBPACK_IMPORTED_MODULE_6__/* .default */ .Z, {
      showResults: this.showResults,
      toggleResults: this.toggleResults,
      updateOverlayOptions: this.updateOverlayOptions
    }), this.props.shouldIntegrateWithDom && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_dom_event_handler__WEBPACK_IMPORTED_MODULE_7__/* .default */ .Z, {
    ...
    }), portalFn( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_overlay__WEBPACK_IMPORTED_MODULE_8__/* .default */ .Z, {
      ...
      isVisible: this.state.isVisible
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_search_results__WEBPACK_IMPORTED_MODULE_9__/* .default */ .Z, {
      closeOverlay: this.hideResults,
...
/* harmony default export */ __webpack_exports__["Z"] = ((0,react_redux__WEBPACK_IMPORTED_MODULE_4__/* .connect */ .$j)((state, props) => ({
  filters: (0,_store_selectors__WEBPACK_IMPORTED_MODULE_14__/* .getFilters */ .Zj)(state),
  staticFilters: (0,_store_selectors__WEBPACK_IMPORTED_MODULE_14__/* .getStaticFilters */ .Bk)(state),
  hasActiveQuery: (0,_store_selectors__WEBPACK_IMPORTED_MODULE_14__/* .hasActiveQuery */ .en)(state),
  hasError: (0,_store_selectors__WEBPACK_IMPORTED_MODULE_14__/* .hasError */ .xT)(state),
  isHistoryNavigation: (0,_store_selectors__WEBPACK_IMPORTED_MODULE_14__/* .isHistoryNavigation */ .wI)(state),
  hasNextPage: (0,_store_selectors__WEBPACK_IMPORTED_MODULE_14__/* .hasNextPage */ .Qy)(state),
  isLoading: (0,_store_selectors__WEBPACK_IMPORTED_MODULE_14__/* .isLoading */ .hg)(state),
  response: (0,_store_selectors__WEBPACK_IMPORTED_MODULE_14__/* .getResponse */ .ck)(state),
  searchQuery: (0,_store_selectors__WEBPACK_IMPORTED_MODULE_14__/* .getSearchQuery */ .uP)(state),
  sort: (0,_store_selectors__WEBPACK_IMPORTED_MODULE_14__/* .getSort */ .r$)(state, props.overlayOptions.defaultSort),
  widgetOutsideOverlay: (0,_store_selectors__WEBPACK_IMPORTED_MODULE_14__/* .getWidgetOutsideOverlay */ .ZN)(state)
}), {
  clearQueryValues: _store_actions__WEBPACK_IMPORTED_MODULE_15__/* .clearQueryValues */ .Mz,
  disableQueryStringIntegration: _store_actions__WEBPACK_IMPORTED_MODULE_15__/* .disableQueryStringIntegration */ .OZ,
  initializeQueryValues: _store_actions__WEBPACK_IMPORTED_MODULE_15__/* .initializeQueryValues */ .Ln,
  makeSearchRequest: _store_actions__WEBPACK_IMPORTED_MODULE_15__/* .makeSearchRequest */ .x1,
  setStaticFilter: _store_actions__WEBPACK_IMPORTED_MODULE_15__/* .setStaticFilter */ .O1,
  setFilter: _store_actions__WEBPACK_IMPORTED_MODULE_15__/* .setFilter */ .Tv,
  setSearchQuery: _store_actions__WEBPACK_IMPORTED_MODULE_15__/* .setSearchQuery */ .ql,
  setSort: _store_actions__WEBPACK_IMPORTED_MODULE_15__/* .setSort */ .HD
})(SearchApp));
...
const SearchBox = props => {
  ...
  const [inputId] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(() => lodash_uniqueId__WEBPACK_IMPORTED_MODULE_2___default()('jetpack-instant-search__box-input-'));
  ...
  }, __('Site Search', 'jetpack')), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "jetpack-instant-search__box-gridicon"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_gridicon__WEBPACK_IMPORTED_MODULE_3__/* .default */ .Z, {
    icon: "search",
    size: 24
...
const SearchControls = props => {
  ...
  }, props.children, props.enableSort && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_search_sort__WEBPACK_IMPORTED_MODULE_1__/* .default */ .Z, {
...
class SearchFilter extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
  constructor(...args) {
    super(...args);

    _home_runner_work_jetpack_jetpack_node_modules_pnpm_babel_runtime_7_15_3_node_modules_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(this, "filtersList", /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_1__.createRef)());
  ...
  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("h4", {
      className: "jetpack-instant-search__search-filter-sub-heading"
    }, this.props.configuration.name), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
    ...
    }, this.props.type === 'group' && this.renderGroups()), this.props.aggregation && 'buckets' in this.props.aggregation && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
...
class SearchFilters extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
  constructor(...args) {
    super(...args);
    ...
    _home_runner_work_jetpack_jetpack_node_modules_pnpm_babel_runtime_7_15_3_node_modules_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(this, "renderFilterComponent", ({
      configuration,
      results
    }) => results && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_search_filter__WEBPACK_IMPORTED_MODULE_4__/* .default */ .Z, {
      aggregation: results,
    ...
    _home_runner_work_jetpack_jetpack_node_modules_pnpm_babel_runtime_7_15_3_node_modules_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(this, "renderStaticFilterComponent", configuration => {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_search_filter__WEBPACK_IMPORTED_MODULE_4__/* .default */ .Z, {
        aggregation: [],
        configuration: configuration,
        locale: this.props.locale,
  ...
  render() {
    ...
    }, this.props.showTitle && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
      className: "jetpack-instant-search__search-filters-title"
    }, __('Filter options', 'jetpack')), this.props.showClearFiltersButton && this.hasActiveFilters() && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("a", {
...
class SearchForm extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
  ...
  render() {
    ...
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_search_box__WEBPACK_IMPORTED_MODULE_2__/* .default */ .Z, {
...
function SearchResultExpanded(props) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", {
  ...
  })), !isMultiSite && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_path_breadcrumbs__WEBPACK_IMPORTED_MODULE_1__/* .default */ .Z, {
  ...
  }), highlight.comments && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_search_result_comments__WEBPACK_IMPORTED_MODULE_3__/* .default */ .Z, {
  ...
  }, firstImage ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_photon_image__WEBPACK_IMPORTED_MODULE_2__/* .default */ .Z, {
    ...
    src: `//${firstImage}`
  }) : null))), isMultiSite && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul", {
    className: "jetpack-instant-search__search-result-expanded__footer"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_photon_image__WEBPACK_IMPORTED_MODULE_2__/* .default */ .Z, {
  ...
  }, fields.blog_name)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "jetpack-instant-search__search-result-expanded__footer-author"
  }, fields.author)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
...
class SearchResultMinimal extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
  getIconSize() {
    return 18;
  }
  ...
  renderNoMatchingContent() {
    ...
    }, noTags && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_path_breadcrumbs__WEBPACK_IMPORTED_MODULE_2__/* .default */ .Z, {
      url: this.props.result.fields['permalink.url.raw']
    }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "jetpack-instant-search__search-result-minimal-cats-and-tags"
    }, tags.length !== 0 && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul", {
      className: "jetpack-instant-search__search-result-minimal-tags"
    }, tags.map(tag => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", {
    ...
    }, tag)))), cats.length !== 0 && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul", {
      className: "jetpack-instant-search__search-result-minimal-cats"
    }, cats.map(cat => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", {
  ...
  render() {
    ...
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_post_type_icon__WEBPACK_IMPORTED_MODULE_3__/* .default */ .Z, {
    ...
    })), noMatchingContent ? this.renderNoMatchingContent() : this.renderMatchingContent(), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_search_result_comments__WEBPACK_IMPORTED_MODULE_4__/* .default */ .Z, {
...
class SearchResultProduct extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
  render() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", {
    ...
    }, firstImage ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_photon_image__WEBPACK_IMPORTED_MODULE_3__/* .default */ .Z, {
      alt: fields['title.default'],
      ...
      className: "jetpack-instant-search__search-result-product-img"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_gridicon__WEBPACK_IMPORTED_MODULE_2__/* .default */ .Z, {
      icon: "block",
    ...
    })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_product_price__WEBPACK_IMPORTED_MODULE_5__/* .default */ .Z, {
    ...
    }), !!fields['meta._wc_average_rating.double'] && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_product_ratings__WEBPACK_IMPORTED_MODULE_4__/* .default */ .Z, {
      count: fields['meta._wc_review_count.long'],
      rating: fields['meta._wc_average_rating.double'],
      permalink: `//${fields['permalink.url.raw']}`
    }), showMatchHint && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "jetpack-instant-search__search-result-product-match"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("mark", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_gridicon__WEBPACK_IMPORTED_MODULE_2__/* .default */ .Z, {
      icon: "search",
      style: {},
      title: false
    }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.sprintf)(
...
class SearchResult extends react__WEBPACK_IMPORTED_MODULE_2__.Component {
  constructor(...args) {
    super(...args);
  ...
  render() {
    if (this.props.resultFormat === _lib_constants__WEBPACK_IMPORTED_MODULE_7__/* .RESULT_FORMAT_PRODUCT */ .LI) {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_search_result_product__WEBPACK_IMPORTED_MODULE_5__/* .default */ .Z, _home_runner_work_jetpack_jetpack_node_modules_pnpm_babel_runtime_7_15_3_node_modules_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_search_result_expanded__WEBPACK_IMPORTED_MODULE_4__/* .default */ .Z, _home_runner_work_jetpack_jetpack_node_modules_pnpm_babel_runtime_7_15_3_node_modules_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
        onClick: this.onClick
      }, this.props, {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_search_result_minimal__WEBPACK_IMPORTED_MODULE_3__/* .default */ .Z, _home_runner_work_jetpack_jetpack_node_modules_pnpm_babel_runtime_7_15_3_node_modules_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
      onClick: this.onClick
    }, this.props));
  }
...
class SearchResults extends react__WEBPACK_IMPORTED_MODULE_2__.Component {
  constructor(...args) {
    super(...args);
  ...
  renderPrimarySection() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(react__WEBPACK_IMPORTED_MODULE_2__.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement("style", {
    ...
    }, this.getSearchTitle()), hasResults && hasCorrectedQuery && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement("p", {
      className: "jetpack-instant-search__search-results-unused-query"
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.sprintf)(__('No results for "%s"', 'jetpack'), searchQuery)), this.props.hasError && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_notice__WEBPACK_IMPORTED_MODULE_4__/* .default */ .Z, {
      type: "warning"
    }, __("It looks like you're offline. Please reconnect for results.", 'jetpack')), hasResults && !this.props.hasError && this.props.response._isOffline && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_notice__WEBPACK_IMPORTED_MODULE_4__/* .default */ .Z, {
      type: "warning"
    }, __("It looks like you're offline. Please reconnect to load the latest results.", 'jetpack')), hasResults && !this.props.hasError && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement("ol", {
      className: `jetpack-instant-search__search-results-list is-format-${this.props.resultFormat}`
    }, results.map((result, index) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_search_result__WEBPACK_IMPORTED_MODULE_8__/* .default */ .Z, {
      index: index,
      staticFilters: this.props.staticFilters,
      isPhotonEnabled: this.props.isPhotonEnabled,
      locale: this.props.locale,
      ...
      searchQuery: this.props.searchQuery
    }))), hasResults && this.props.hasNextPage && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", {
      className: "jetpack-instant-search__search-results-pagination"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_scroll_button__WEBPACK_IMPORTED_MODULE_5__/* .default */ .Z, {
  ...
  renderSecondarySection() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_sidebar__WEBPACK_IMPORTED_MODULE_9__/* .default */ .Z, {
      filters: this.props.filters,
      staticFilters: this.props.staticFilters,
      isLoading: this.props.isLoading,
      locale: this.props.locale,
  ...
  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", {
    ...
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_search_form__WEBPACK_IMPORTED_MODULE_7__/* .default */ .Z, {
    ...
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_gridicon__WEBPACK_IMPORTED_MODULE_3__/* .default */ .Z, {
      icon: "cross",
      size: "24",
      "aria-hidden": "true",
      focusable: "false"
    }))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_search_controls__WEBPACK_IMPORTED_MODULE_6__/* .default */ .Z, {
      enableSort: this.props.enableSort,
      onChangeSort: this.props.onChangeSort,
      resultFormat: this.props.resultFormat,
      sort: this.props.sort
    }, (this.hasFilterOptions() || this.props.hasNonSearchWidgets) && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", {
      role: "button",
      onClick: this.toggleMobileSecondary,
      onKeyDown: this.toggleMobileSecondary,
      tabIndex: "0",
      className: "jetpack-instant-search__search-results-filter-button"
    }, __('Filters', 'jetpack'), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_gridicon__WEBPACK_IMPORTED_MODULE_3__/* .default */ .Z, {
      icon: "chevron-down",
      size: 16,
      ...
      className: "screen-reader-text assistive-text"
    }, this.state.shouldShowMobileSecondary ? __('Hide filters', 'jetpack') : __('Show filters', 'jetpack')))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", {
      className: "jetpack-instant-search__search-results-content"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", {
      className: "jetpack-instant-search__search-results-primary"
    }, this.renderPrimarySection()), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", {
...
class SearchSort extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
  constructor(...args) {
    super(...args);
  ...
  render() {
    ...
    if (sortOptions.size > 3) {
      ...
      }, __('Sort:', 'jetpack')), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("select", {
        id: "jetpack-instant-search__search-sort-select",
        onBlur: this.handleSelectChange,
        onChange: this.handleSelectChange
      }, [...sortOptions.entries()].map(([sortKey, label]) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("option", {
        value: sortKey,
        key: sortKey,
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
      ...
      className: "screen-reader-text"
    }, __('Sort by: ', 'jetpack')), [...sortOptions.entries()].map(([sortKey, label]) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("a", {
...
/* harmony import */ var _search_filters__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9034);
/* harmony import */ var _widget_area_container__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7784);
/* harmony import */ var _jetpack_colophon__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5504);
/**
 * External dependencies
 */
...
const Sidebar = props => {
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_search_filters__WEBPACK_IMPORTED_MODULE_2__/* .default */ .Z, {
  ...
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_widget_area_container__WEBPACK_IMPORTED_MODULE_3__/* .default */ .Z, null), props.widgets.map(widget => {
  ...
  }), props.showPoweredBy && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_jetpack_colophon__WEBPACK_IMPORTED_MODULE_4__/* .default */ .Z, {
    locale: props.locale
  }));
};
...
class WidgetAreaContainer extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
  constructor(...args) {
    super(...args);

    _home_runner_work_jetpack_jetpack_node_modules_pnpm_babel_runtime_7_15_3_node_modules_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(this, "container", /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_1__.createRef)());
  }
...
/* harmony import */ var tiny_lru_lib_tiny_lru_esm__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1940);
...
/* harmony export */ });
/* unused harmony export isInCustomizer */
...
/* harmony export */ });
/* harmony import */ var photon__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7511);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3804);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/**
 * External dependencies
...
function usePhoton(initialSrc, width, height, isPhotonEnabled = true) {
  const [src, setSrc] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null);
...
module.exports = __webpack_require__(9623)(exports);
const {
  formatters
} = module.exports;
/**
...
function setup(env) {
  ...
  createDebug.humanize = __webpack_require__(2002);
...
/* harmony export */ });
class t{constructor(t=0,s=0){this.first=null,this.items=Object.create(null),this.last=null,this.max=t,this.size=0,this.ttl=s}has(t){return t in this.items}clear(){return this.first=null,this.items=Object.create(null),this.last=null,this.size=0,this}delete(t){if(this.has(t)){const s=this.items[t];delete this.items[t],this.size--,null!==s.prev&&(s.prev.next=s.next),null!==s.next&&(s.next.prev=s.prev),this.first===s&&(this.first=s.next),this.last===s&&(this.last=s.prev)}return this}evict(){const t=this.first;return delete this.items[t.key],this.first=t.next,this.first.prev=null,this.size--,this}get(t){let s;if(this.has(t)){const e=this.items[t];this.ttl>0&&e.expiry<=(new Date).getTime()?this.delete(t):(s=e.value,this.set(t,s,!0))}return s}keys(){return Object.keys(this.items)}set(t,s,e=!1){let i;if(e||this.has(t)){if(i=this.items[t],i.value=s,!1===e&&(i.expiry=this.ttl>0?(new Date).getTime()+this.ttl:this.ttl),this.last!==i){const t=this.last,s=i.next,e=i.prev;this.first===i&&(this.first=i.next),i.next=null,i.prev=this.last,t.next=i,null!==e&&(e.next=s),null!==s&&(s.prev=e)}}else this.max>0&&this.size===this.max&&this.evict(),i=this.items[t]={expiry:this.ttl>0?(new Date).getTime()+this.ttl:this.ttl,key:t,prev:this.last,next:null,value:s},1==++this.size?this.first=i:this.last.next=i;return this.last=i,this}}/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(s=1e3,e=0){if(isNaN(s)||s<0)throw new TypeError("Invalid max value");if(isNaN(e)||e<0)throw new TypeError("Invalid ttl value");return new t(s,e)}
...
/* harmony export */ });
/* harmony import */ var _setPrototypeOf_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2450);
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3027);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_layout__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2213);
/**
 * WordPress dependencies
 */
...
function initialize(id) {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.render)( /*#__PURE__*/React.createElement(_components_layout__WEBPACK_IMPORTED_MODULE_1__/* .default */ .Z, null), document.getElementById(id));
}
