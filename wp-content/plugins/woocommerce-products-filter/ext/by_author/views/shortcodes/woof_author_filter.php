    ...
    <div class="woof_container_inner">
        ...
        if (!empty($authors_title)) {
            foreach ($authors_title as $user) {
                ?>
                <input type="hidden" value="<?php echo esc_html__('Author:', 'woocommerce-products-filter'), $user->data->display_name; ?>" data-anchor="woof_n_<?php echo "woof_author" ?>_<?php echo $user->data->ID ?>" />
                <?php
            }
        }
        ?>               
