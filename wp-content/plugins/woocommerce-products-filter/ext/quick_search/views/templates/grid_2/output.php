    ...
    <div class="qs_cards woof_qs_container">
        <div class="qs_card woof_qs_item">
            ...
            <div class="card-title">
                ...
                <h2 class="woof_qs_<?php echo $template_result ?>_title card__title" ><a class="woof_qs_link" href="__URL__" target="__TARGET__">__TITLE__</a></h2>   
                <?php if (isset($structure['price'])): ?>
                    <div class="woof_qs_<?php echo $template_result ?>_price" >__PRICE__</div>
                <?php endif; ?>
            </div>
            <div class="card-flap flap1">
                <div class="card-description">
                    <?php if (isset($structure['sku'])): ?>
                        <p class="card__text woof_qs_<?php echo $template_result ?>_sku" ><?php echo $structure['sku']['title'], ":"; ?>__SKU__</p>
                    <?php endif; ?>
                    <?php if (isset($structure['key_words'])): ?>
                        <p class="card__text woof_qs_<?php echo $template_result ?>_key_words" ><?php echo $structure['key_words']['title'], ":"; ?>__KEY_WORDS__</p>
                    <?php endif; ?>
        ...
        <div class="woof_qs_no_products_item">
            <div class='woof_qs_no_products woof_qs_no_products_<?php echo $template_result ?>'>
