                                ...
                                foreach ($terms as $term) {
                                    ...
                                    <div class="woof_qt_item_container">
                                        ...
                                        <label class="woof_qt_radio_label" <!--for="term_<?php echo $unique_id ?>"-->><?php echo $term->name ?>
                                            <span class="woof_qt_radio_reset tax_<?php echo $filter_struct[1] ?>_reset" data-tax="<?php echo $filter_struct[1] ?>" ><img src="<?php echo $this->settings['delete_image'] ?>" height="12" width="12" alt="" /></span>
                                        </label>
                                    </div>
                                    <?php
                                }
