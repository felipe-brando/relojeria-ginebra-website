    ...
    <div class="woof-tabs woof-tabs-style-line">
        ...
        <div class="content-wrap">
            ...
            <section>
                ...
                <a href="https://products-filter.com/extencion/quick-search/" target="_blank" class="button-primary"><?php echo esc_html__('About extension', 'woocommerce-products-filter') ?></a><br />
                <br />
                ...
                <div class="woof-control-section woof_update_search_data_file">
                    ...
                    <div class="woof-control-container">
                        ...
                        <div class="woof-control">
                            <a id="woof_quick_search_update"  class="button" ><?php esc_html_e('Update now!', 'woocommerce-products-filter') ?></a><span class="woof_qt_messange"></span><span class="woof_qt_product_count"></span>
                        </div>
                        <div class="woof-description">
                ...
                <div class="woof-control-section woof_file_data_option" >
                    ...
                    <h4><?php esc_html_e('Additional Quick-search Filter options', 'woocommerce-products-filter') ?></h4>
                    <?php
