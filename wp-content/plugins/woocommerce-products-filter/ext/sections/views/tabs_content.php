    ...
    <div class="woof-tabs woof-tabs-style-line">
        ...
        <div class="content-wrap">
            ...
            <section>
                ...
                <a href="https://products-filter.com/extencion/sections/" target="_blank" class="button-primary"><?php echo esc_html__('About extension', 'woocommerce-products-filter') ?></a><br />
                <br />

                <p class="description"><?php esc_html_e("Allows to wrap filter-elements into [close/open]-sections and make filter form more compact.", 'woocommerce-products-filter') ?></p>
                ...
                <div class="woof-control-section">
                    ...
                    <h4><?php esc_html_e('Add section', 'woocommerce-products-filter') ?></h4>
                ...
                <div class="woof-control-section">
                    ...
                    <div class="woof-control-container">
                        <div class="woof-control">
                            <input type="button" class="woof-button" id="woof_sections_generate" value="<?php esc_html_e("Generate attributes for shortcode [woof]", 'woocommerce-products-filter') ?>">
                        </div>
                        <div class="woof-description">
