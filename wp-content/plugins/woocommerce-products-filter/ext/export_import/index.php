...
final class WOOF_EXP_IMP extends WOOF_EXT {
    ...
    public function do_import_data() {
        ...
        if (!isset($_POST['import_value'])) {
            die(__("Error! No data", 'woocommerce-products-filter'));
        }
        ...
        try {
            ...
            die(__("Settings imported successfully. Reload the page please.", 'woocommerce-products-filter'));
        } catch (Exception $e) {
            die(__("Error!", 'woocommerce-products-filter'));
        }
    }
