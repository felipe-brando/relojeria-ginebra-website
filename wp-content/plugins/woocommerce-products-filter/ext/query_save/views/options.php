...
<li data-key="<?php echo $key ?>" class="woof_options_li">
    ...
    <img class="help_tip" data-tip="<?php esc_html_e('User can save the search query', 'woocommerce-products-filter') ?>" src="<?php echo WP_PLUGIN_URL ?>/woocommerce/assets/images/help.png" height="16" width="16" />
