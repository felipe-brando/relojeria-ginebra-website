...
final class WOOF_EXT_TURBO_MODE extends WOOF_EXT {
    ...
    public function woof_print_applications_tabs_content() {
        ...
        ob_start();
        ?>
        var woof_turbo_creating = "<?php echo esc_html__('Creating', 'woocommerce-products-filter') ?>";
        var woof_turbo_products = "<?php echo esc_html__('Products and Variants', 'woocommerce-products-filter') ?>";		
        <?php
        $txt_js = ob_get_clean();
