    ...
    <div class="woof-tabs woof-tabs-style-line">
        ...
        <div class="content-wrap">
            ...
            <section>
                ...
                <em><?php esc_html_e('Boost speed of products filtering. This mode allows to avoid generating big MySQL queries while products filtering on the site front what makes less loading to the server and getting filtering results more quick', 'woocommerce-products-filter') ?></em>

                <a href="https://products-filter.com/extencion/turbo-mode/" target="_blank" class="button-primary"><?php echo esc_html__('More about extension', 'woocommerce-products-filter') ?></a><br />
                ...
                <div class="woof-control-section woof_update_search_data_file">
                    ...
                    <div class="woof-control-container">
                        <div class="woof-control">
                            <a id="woof_turbo_mode_update"  class="button" ><?php esc_html_e('Update now!', 'woocommerce-products-filter') ?></a>
