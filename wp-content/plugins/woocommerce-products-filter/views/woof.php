    ...
    function woof_show_btn($autosubmit = 1, $ajax_redraw = 0) {
        ...
        <div class="woof_submit_search_form_container">
            ...
            <?php if (!$autosubmit OR $ajax_redraw): ?>
                ...
                ?>
                <button class="button woof_submit_search_form"><?php echo $woof_filter_btn_txt ?></button>
            <?php endif; ?>
...
<?php if ($autohide): ?>
    <div>
		...
		?>
				...
				<div class="woof <?php if (!empty($sid)): ?>woof_sid woof_sid_<?php echo $sid ?><?php endif; ?> <?php echo $woof_class ?>" <?php if (!empty($sid)): ?>data-sid="<?php echo $sid; ?>"<?php endif; ?> data-shortcode="<?php echo(isset($_REQUEST['woof_shortcode_txt']) ? $_REQUEST['woof_shortcode_txt'] : 'woof') ?>" data-redirect="<?php echo $redirect ?>" data-autosubmit="<?php echo $autosubmit ?>" data-ajax-redraw="<?php echo $ajax_redraw ?>">
		<?php	
			...
			if (wp_is_mobile() &&  (isset($mobile_mode) && $mobile_mode) && isset($sid)) {
				...
				?>
				<div class="woof_show_mobile_filter" data-sid="<?php echo $sid; ?>">
					<?php if($image_mb_open!=-1) : ?>
					<img src="<?php echo $image_mb_open; ?>">
					<?php endif; ?>
				...
				<div class="woof_hide_mobile_filter" >
					...
					<span><?php echo  WOOF_HELPER::wpml_translate(null, $text_mb_close); ?></span>
					<?php endif; ?>
				</div>
				<?php
			}
			?>
                <?php if ($show_woof_edit_view AND!empty($sid)): ?>
                    <a href="#" class="woof_edit_view" data-sid="<?php echo $sid ?>"><?php esc_html_e('show blocks helper', 'woocommerce-products-filter') ?></a>
                    <div></div>
                <?php endif; ?>
