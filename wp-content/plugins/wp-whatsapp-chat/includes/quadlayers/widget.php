...
?>
        ...
        <div style="display: flex; justify-content: space-between;align-items: center;margin: 16px -12px 0;padding: 12px 12px 0; border-top: 1px solid #eee;">
            <a href="<?php printf('https://quadlayers.com/blog/?utm_source=%s&utm_medium=software&utm_campaign=wordpress&utm_content=dashboard', QLWAPP_DOMAIN); ?>" target="_blank"><?php esc_html_e('Read more like this on our blog', 'wp-whatsapp-chat') ?></a>
            <a class="button-primary" href="<?php printf('https://quadlayers.com/?utm_source=%s&utm_medium=software&utm_campaign=wordpress&utm_content=dashboard', QLWAPP_DOMAIN); ?>" target="_blank"><?php esc_html_e('QuadLayers', 'wp-whatsapp-chat') ?></a>
        </div>
<?php
    }
