...
{
    return \PixelCaffeine\Dependencies\Ramsey\Uuid\Uuid::uuid1($node, $clockSeq)->toString();
}
/**
...
function v3($ns, $name)
{
    return \PixelCaffeine\Dependencies\Ramsey\Uuid\Uuid::uuid3($ns, $name)->toString();
}
/**
...
function v4()
{
    return \PixelCaffeine\Dependencies\Ramsey\Uuid\Uuid::uuid4()->toString();
}
/**
...
function v5($ns, $name)
{
    return \PixelCaffeine\Dependencies\Ramsey\Uuid\Uuid::uuid5($ns, $name)->toString();
}
