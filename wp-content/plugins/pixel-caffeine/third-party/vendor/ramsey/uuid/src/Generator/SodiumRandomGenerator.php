 ...
 */
class SodiumRandomGenerator implements \PixelCaffeine\Dependencies\Ramsey\Uuid\Generator\RandomGeneratorInterface
{
    /**
    ...
    {
        return \PixelCaffeine\Dependencies\Sodium\randombytes_buf($length);
    }
}
