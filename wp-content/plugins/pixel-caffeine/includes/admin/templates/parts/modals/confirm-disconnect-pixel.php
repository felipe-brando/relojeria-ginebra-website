	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><?php esc_html_e( 'Disconnect your Pixel ID', 'pixel-caffeine' ); ?></h4>
			</div>
			<div class="modal-body">
				<p><?php esc_html_e( 'Are you sure you want to disconnect your Pixel ID?', 'pixel-caffeine' ); ?></p>
			</div>
